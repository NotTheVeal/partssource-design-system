...
export const ListTypeBadge: React.FC<ListTypeBadgeProps> = ({
  children,
  tone = "shopping",
  className = "",
}) => (
...
export const Badge = { StatusBadge, ListTypeBadge };

// ── Window export so other Babel-loaded scripts can read these ───
declare const window: Window & {
  StatusBadge?: typeof StatusBadge;
  ListTypeBadge?: typeof ListTypeBadge;
};
if (typeof window !== "undefined") {
  Object.assign(window, { StatusBadge, ListTypeBadge });
}
