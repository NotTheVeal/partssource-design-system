...
export const TextBlock: React.FC<TextBlockProps> = ({ title, children, className = "" }) => (
...
export const CMS = { Banner, ImageBlock, TextBlock, CardGrid };
...
if (typeof window !== "undefined") {
  Object.assign(window, { Banner, ImageBlock, TextBlock, CardGrid });
}
