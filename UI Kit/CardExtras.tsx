...
export const AiDataCard: React.FC<AiDataCardProps> = ({
  title,
  manufacturer,
  meta,
  badges,
...
export const CardExtras = { AiDataCard, ProductCard, AnalyticsCard, ListCard };

// ── Window export so other Babel-loaded scripts can read these ───
declare const window: Window & {
  AiDataCard?: typeof AiDataCard;
  ProductCard?: typeof ProductCard;
  AnalyticsCard?: typeof AnalyticsCard;
  ListCard?: typeof ListCard;
};
if (typeof window !== "undefined") {
  Object.assign(window, { AiDataCard, ProductCard, AnalyticsCard, ListCard });
}
