...
export const AvatarGroup: React.FC<AvatarGroupProps> = ({ children, overflow, size = "md" }) => {
  const sz = avatarSize[size];
  return (
...
export const TooltipRich: React.FC<TooltipRichProps> = ({ title, body, cta, className = "" }) => (
  <div
    role="tooltip"
    className={cxF(
...
export const SkeletonKeyframes: React.FC = () => {
  React.useEffect(() => {
...
export const Feedback = { Avatar, AvatarGroup, Tooltip, TooltipRich, Skeleton, SkeletonKeyframes, Spinner: LoadingSpinner, EmptyState, ErrorPage };
