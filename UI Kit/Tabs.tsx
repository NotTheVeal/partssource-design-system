...
// ── FolderTabs ───────────────────────────────────────────────────
export const FolderTabs: React.FC<TabsProps> = ({
  items,
  activeId,
  defaultActiveId,
  onChange,
...
export const Tabs = { FolderTabs, SegmentedTabs, PillTabs };

// ── Window export so other Babel-loaded scripts can read these ───
declare const window: Window & {
  FolderTabs?: typeof FolderTabs;
  SegmentedTabs?: typeof SegmentedTabs;
  PillTabs?: typeof PillTabs;
};
if (typeof window !== "undefined") {
  Object.assign(window, { FolderTabs, SegmentedTabs, PillTabs });
}
